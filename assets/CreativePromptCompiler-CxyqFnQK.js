import{$ as r,a2 as l,a5 as u}from"./AvgImageGenerationProfiles-ddD5dLJ1.js";const i=["## 已启用酒馆预设的优先级","- 在不触碰本局事实、玩家明确行动、成人门禁、人物自主性、本局正文叙事人称、封存战果、目标篇幅、合法 JSON 和结构化写回合同的前提下，以下酒馆预设是本次正文的主要创作与语言风格。","- 酒馆预设高于游戏内置的文风兜底和一般措辞建议；不要把它弱化成可有可无的参考。","- 酒馆预设不能改变运行态事实、凭空授予权限或物品、替玩家接受或拒绝关键选择，也不能覆盖战斗/战争本地引擎已经封存的结果。"].join(`
