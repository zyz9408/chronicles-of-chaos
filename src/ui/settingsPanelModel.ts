...
export const FUNCTION_CONFIG_PANELS: FunctionConfigPanel[] = [
  {
    tab: 'memory',
    label: '记忆配置',
    description: '管理正文剧情、主角经历、NPC、地点与分层摘要的记忆压缩、执行模式和投喂预算。',
  ...
  },
  {
    tab: 'npcProfile',
    label: 'NPC建档配置',
    description: '管理开局历史人物补全与 NPC 基础档案生成；独立模式可配置主要、备用 API。',
  ...
  },
  {
    tab: 'npcSimulation',
    label: 'NPC动态模拟配置',
    description: '管理本回合相关 NPC 的结构化反应轨迹、功能开关和执行模式。',
  ...
  },
  {
    tab: 'worldEvolution',
    label: '后台世界演化配置',
    description: '管理离场羁绊与红颜人物的到期行动、历史轨迹推进、近况投递和执行模式；它独立于当前回合 NPC 反应模拟。',
  ...
  },
  {
    tab: 'stateWriteback',
    label: '状态写回配置',
    description: '管理主回合状态补丁与写回结构整理的执行模式；独立模式才使用专用 API。',
