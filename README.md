...
[English](README.en.md) · **v1.7.24** · [在线游玩](https://cocsg.pages.dev/)
...
- 完善个人战斗、战争、兵种克制、统率与绝艺投影，战斗结果由本地规则结算并进入长期状态。
- 扩展领地、私人产业、部队、书信、关系人物演化、人物记忆、云存档与变量管理。
- 增加剧情、个人战斗和战争难度设置，并改进开局、地图、人物志、背包及移动端交互。
- 增加智谱 GLM Coding Plan 与 MiniMax 国内/国际接口预设，兼容 OpenAI、DeepSeek、Gemini、Claude、Qwen 等常见接口。
